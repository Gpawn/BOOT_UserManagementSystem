		...
		<form class="form-horizontal" action="<%=path%>user/register">
			...
			<div class="row bottomblock">
				...
				<div class="form-group col-sm-10 col-sm-offset-2">
					<label class="col-sm-2 control-label col-sm-offset-2">名 称：</label>
					<div class="col-sm-6">
						<input type="text" class="form-control" id="RegName" name="user.userName"
							   value="${user.userName}" />
					</div>
				</div>
				<div class="form-group col-sm-10 col-sm-offset-2">
					...
					<div class="col-sm-6">
						<input type="password" class="form-control"
							   id="RegPassword" name="user.userPassword"
